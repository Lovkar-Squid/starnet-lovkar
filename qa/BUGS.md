...
**4** open (open+claimed) of 133 total — 0 P0 · 4 P1 · 0 P2

Engineering status is separate from delivery and customer recovery. Legacy rows without origin are not a customer census.

User/owner reports: **59** · source fixed: **55** · installer verified: **6** · customer confirmed: **1** · still reported failing: **1** · recovery unconfirmed: **57**.
